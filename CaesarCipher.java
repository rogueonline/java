...
public class CaesarCipher {
	 ...
	 */
	public String encrypt(String string, int offset) throws IllegalArgumentException {
	 ...
	 * @throws IllegalArgumentException
	 */
	public String decrypt(String string, int offset) throws IllegalArgumentException {
		if ((offset < 0) || (offset > 25)) {
			throw new IllegalArgumentException("Offset must be between 0-25");
		}
